...
<qgis hasScaleBasedVisibilityFlag="0" simplifyLocal="1" version="3.16.5-Hannover" simplifyMaxScale="1" maxScale="0" simplifyDrawingTol="1" labelsEnabled="0" simplifyAlgorithm="0" minScale="100000000" styleCategories="AllStyleCategories" simplifyDrawingHints="1" readOnly="0">
  ...
  <renderer-v2 type="RuleRenderer" forceraster="0" enableorderby="0" symbollevels="0">
    <rules key="{7df65e36-6ce3-43e2-bc80-a5fbfdea63a6}">
      <rule filter="&quot;EL-Bezue_1&quot; &lt; 0.02" label="&lt; 2.00 %" key="{6aed43d2-106e-4403-ae3e-f1e3077a9286}" symbol="0"/>
      <rule filter=" &quot;EL-Bezue_1&quot; >= 0.02 AND &quot;EL-Bezue_1&quot; &lt; 0.03" label="2.00 % - 2.99 %" key="{32785dc5-1158-403d-ab90-51348b6dbec0}" symbol="1"/>
      <rule filter=" &quot;EL-Bezue_1&quot; >= 0.03 AND &quot;EL-Bezue_1&quot; &lt; 0.04" label="3.00 % - 3.99 %" key="{b28c2fb3-e2fa-4475-93cc-dfde0f46da4f}" symbol="2"/>
      <rule filter=" &quot;EL-Bezue_1&quot; >= 0.04 AND &quot;EL-Bezue_1&quot; &lt; 0.05" label="4.00 % - 4.99 %" key="{32785dc5-1158-403d-ab90-51348b6dbec0}" symbol="3"/>
      <rule filter=" &quot;EL-Bezue_1&quot; >= 0.05 " label="> 5.00 %" key="{32785dc5-1158-403d-ab90-51348b6dbec0}" symbol="4"/>
    </rules>
    <symbols>
      <symbol clip_to_extent="1" force_rhr="0" name="0" type="fill" alpha="1">
        <layer pass="0" enabled="1" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="218,238,243,255"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" name="1" type="fill" alpha="1">
        <layer pass="0" enabled="1" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="146,205,220,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
